...
namespace HereticalSolutions.Delegates.Factories
{
    public static partial class DelegatesFactory
    {
        ...
        {
            Func<IInvokableMultipleArgs> valueAllocationDelegate = PoolsFactory.NullAllocationDelegate<IInvokableMultipleArgs>;
        ...
        {
            Func<IInvokableSingleArgGeneric<T>> valueAllocationDelegate = PoolsFactory.NullAllocationDelegate<IInvokableSingleArgGeneric<T>>;
